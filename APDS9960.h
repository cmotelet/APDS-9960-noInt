 ...
 * APDS-9960.h
 *
 * This library interfaces the Avago APDS-9960 to Arduino over I2C.
 *
...
// Gesture parameters
typedef struct gesture_record_t
{
    uint8_t u_data;
    uint8_t d_data;
    uint8_t l_data;
 ...
 */
/* Misc parameters */
#define FIFO_PAUSE_TIME         20      // Wait period (ms) between FIFO reads
